...
**What it is:** A landing site for a Russian road-infrastructure company ("Компас") — traffic lights, signs, speed bumps. Deployed to GitHub Pages at `/compas_web/` (the Vite `base` path reflects this).
